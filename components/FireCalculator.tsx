  ...
  return (
    <div className="flex flex-col gap-block">
      ...
      <section className="prose-blog max-w-prose flex flex-col gap-4">
        ...
        <h3 className="!mt-6 text-sm font-semibold">Применимость в России</h3>
        <p className="text-sm">
          Логика FIRE универсальна, но в России важны инфляция, налоги, ИИС и доступные инструменты (БПИФы, облигации).
          В кризисные периоды многие закладывают ставку изъятия 3–3,5% вместо 4%. Калькулятор учитывает инфляцию
          расходов к моменту выхода на FIRE — цель ближе к реальности, чем расчёт «в сегодняшних рублях».
        </p>
